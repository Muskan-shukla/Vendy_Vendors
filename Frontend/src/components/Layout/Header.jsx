  ...
  return (
    <>
      <div className={`${styles.section}`}>
        <div className="hidden sm:flex sm:items-center sm:justify-between sm:h-[50px] sm:my-[20px]">
          <div>
            <Link to="/">
              <img
          ...
          <div className="w-full sm:w-[50%] relative">
            ...
            {searchData && searchData.length !== 0 ? (
              <div className="absolute min-h-[30vh] bg-slate-50 shadow-sm-2 z-[9] p-4 w-full sm:w-auto">
          ...
          <div className="hidden sm:block">
            <Link to="/shop-create">
              <h1 className="text-[#fff] flex items-center bg-blue-500 p-2 rounded-md">
      ...
      <div className="flex items-center">
        <BiMenuAltLeft size={30} className="mr-4 cursor-pointer" onClick={() => setOpen(true)} />
        <Link to="/">
          <img
            src="https://shopo.quomodothemes.website/assets/images/logo.svg"
            alt="Shop Logo"
            className="h-auto max-h-[50px] w-auto max-w-full cursor-pointer"
          />
        </Link>
      </div>
